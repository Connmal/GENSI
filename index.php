    ...
    <script type="text/javascript">
     ...
     slide_1.append("text")
      ...
      slide_1.append("text")
       .attr("class", "slideText")
       .attr("x", center - textWidth / 2)
       .attr("y", text_offset_top + title_offset_top + lineHeight * 36)
     ...
     slide_1.append("text")
      ...
      .attr("class", "slideText")
      .attr("x", center - textWidth / 2)
      .attr("y", text_offset_top + title_offset_top + lineHeight * 76)
      ...
      .attr("class", "slideText")
      .attr("x", center - textWidth / 2)
      .attr("y", text_offset_top + title_offset_top + lineHeight * 88)
      ...
      .attr("class", "slideText")
      .attr("x", center - textWidth / 2)
      .attr("y", text_offset_top + title_offset_top + lineHeight * 96)
      ...
      .attr("class", "slideText")
      .attr("x", center - textWidth / 2)
      .attr("y", text_offset_top + title_offset_top + lineHeight * 112)
      ...
      .attr("class", "slideText")
      .attr("x", center - textWidth / 2)
      .attr("y", text_offset_top + title_offset_top + lineHeight * 116)
