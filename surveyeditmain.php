  ...
  <body>
    ...
    <script type="text/javascript">
      ...
      function removeLink(l) {
        // Slide 8: draw links between friends that know each other
        if (currSlide == 8) {
     ...
     console.log(document.getElementById("CodeID").value)
     console.log((document.getElementById("CodeID").value).length)
     ...
     if (document.getElementById("CodeID").value.length == 0){
       console.log("nothing entered")
        ...
        document.getElementById("CodeID").value= "  "
          ...
          console.log(document.getElementById("AgeID").value)
          console.log((document.getElementById("AgeID").value).length)
          ...
          var text = $("#slide8 .numfri").text();
          text = text.replace('mensen', 'persoon');
          if (numFriends < 2) $("#slide8 .numfri").text(text);
          currSlide++;
          showNext();
          ...
          document.getElementById("slide8").style.position="none"
        ...
        //Q15 People often tell me that I should try to cheer up.
         ...
         //Q16 Most people are more upbeat and dynamic than I generally am.
          ...
          checked = true;
            ...
            var answer = [nodes[0].q1,(nodes.length > 1) ? nodes[1].name : "", (nodes.length > 1) ? nodes[1].q2 : "",(nodes.length > 1) ? nodes[1].friendsWith : ""];
            ...
            $.post( "save_results.php", {q1: nodes[0].q1,
